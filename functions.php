...
function whc_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'SidebarTwo', 'whc' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html__( 'Add widgets here.', 'whc' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
function whc_scripts() {
	...
	wp_enqueue_style( 'whc-bootstrap_js', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery', '20170710', true ) );
...
// Implament the bootstrap nav-walker 
